 ...
 * 
 */
@WebServiceClient(name = "MovieWebService", targetNamespace = "http://service.technikumwien.at/", wsdlLocation = "http://localhost:8080/MovieServiceWebApp_war_exploded/MovieWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIEWEBSERVICE_QNAME = new QName("http://service.technikumwien.at/", "MovieWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MovieServiceWebApp_war_exploded/MovieWebService?wsdl");
    ...
    public MovieWebService getMovieWebServicePort() {
        return super.getPort(new QName("http://service.technikumwien.at/", "MovieWebServicePort"), MovieWebService.class);
    }
    ...
    public MovieWebService getMovieWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.technikumwien.at/", "MovieWebServicePort"), MovieWebService.class, features);
    }
